...
worksheet.write(0,0, "Author", header_format) # по индексу 0 номер строки 0 номер колонки author верхний левый угол
worksheet.write(0,1, "Quote", header_format) # по индексу 0 номер строки 1 номер колонки 
